...
public class RenderPainting extends Render {
	...
	public void renderThePainting(EntityPainting entityPainting1, double d2, double d4, double d6, float f8, float f9) {
	...
	public void doRender(Entity entity1, double d2, double d4, double d6, float f8, float f9) {
		this.renderThePainting((EntityPainting)entity1, d2, d4, d6, f8, f9);
	}
}
