	...
	public void renderGameOverlay(float renderPartialTick, boolean hasScreen, int width, int height) {
		...
		if(this.mc.playerController.shouldDrawHUD()) {
			...
			for(i14 = 0; i14 < 10; ++i14) {
				...
				if (this.mc.thePlayer.warmness > 5) {
					if(i14 * 2 + 1 < i11) {
					...
					if(i14 * 2 + 1 < i11) {
						this.drawTexturedModalRect(i17, i15, 52, 9, 9, 9);
					}

					if(i14 * 2 + 1 == i11) {
						this.drawTexturedModalRect(i17, i15, 61, 9, 9, 9);
					}					
				}
			}
		...
		if(this.mc.options.d) {
			fontRenderer8.drawStringWithShadow("Minecraft: Cruel Winter - " + this.mc.versionString + " (" + this.mc.debug + ")", 2, 2, 0xFFFFFF);
			...
			fontRenderer8.drawStringWithShadow("Minecraft: Cruel Winter - " + this.mc.versionString, 2, 2, 0xFFFFFF);
		}
		/*fontRenderer8.drawStringWithShadow("Warmness: " + this.mc.thePlayer.warmness + " / 20", 2, 24, 0xFFFFFF);
		fontRenderer8.drawStringWithShadow("Insulation: " + this.mc.thePlayer.insulation, 2, 36, 0xFFFFFF);*/
